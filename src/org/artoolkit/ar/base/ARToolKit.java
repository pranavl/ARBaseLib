...
public class ARToolKit {
    ...
    /**
     * Implementation of the singleton pattern to provide a sole instance of the
     * ARToolKit class.
     *
     ...
     * @param resourcesDirectoryPath The full path (in the filesystem) to the
     * directory to be used by the native routines as the base for relative
     * references. e.g. Activity.getContext().getCacheDir().getAbsolutePath() or
     * Activity.getContext().getFilesDir().getAbsolutePath()
     */
    ...
    /**
     * Returns whether the native library was found and successfully
     * initialised. Native functions will not be called unless this is true.
     *
     ...
     * @param cameraParaPath The full path (in the filesystem) to a camera
     * parameter file, or the path expressed relative to the
     * resourcesDirectoryPath set in initialiseNative().
     ...
     * update the local color array. This is then applied to the debug Bitmap,
     ...
     * @param width The physical width of the marker being tracked, in
     * millimeters.
     ...
     * @return true if the marker is visible and tracked in the current video
     * frame.
     */
